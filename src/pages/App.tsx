        ...
        <>
            ...
            <main className="min-h-screen flex flex-col items-center justify-center bg-gradient-to-br from-sky-50 to-white px-4 text-center">
                ...
                <p className="text-lg md:text-xl text-gray-600 max-w-xl mb-8">
                    Aplikasi Sistem Pendukung Keputusan (SPK) berbasis metode <strong>Profile Matching</strong> dan <strong>Weighted Product</strong> untuk membantu pemilihan terbaik secara objektif dan efisien.
                </p>
